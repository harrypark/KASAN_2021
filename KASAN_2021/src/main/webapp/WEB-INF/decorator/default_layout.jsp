...
<!-- 야근수당신청 메뉴가 사라지는 기준날짜 -->
<fmt:parseDate var="overtimerule"  value="2021-07-16" pattern="yyyy-MM-dd"/>
...
<!--                     	<span>KASAN근태관리</span> -->
                    ...
                    <ul class="nav metismenu" id="side-menu">
	                    ...
	                    <c:choose>
							...
							<c:if test="${now <= overtimerule }">
		                    <li>
		                        <a href="<c:url value="/overtime/ulist"/>" class="menu"><i class="fa fa-clock-o"></i> <span class="nav-label">야근수당신청 </span></a>
		                    </li>
		                    </c:if>
	                    	...
	                    	<li>
		                        <a href="<c:url value="/overtime/alist"/>" class="menu"><i class="fa fa-desktop"></i> <span class="nav-label">야근수당신청</span></a>
		                    </li>
		                    <li>
